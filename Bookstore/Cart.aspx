<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Bookstore.Cart" %>
                            ...
                            <table class="table table-hover shopping-cart-wrap" id="T">
                                <thead class="text-muted">
                                    <tr class="text-center">
                                        <th scope="col" width="600">Book</th>
                                        <th scope="col" width="180">Author</th>
                                        <th scope="col" width="180">Genre</th>
