<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookInfo.aspx.cs" Inherits="Bookstore.BookInfo" %>
                        ...
                        <div class="col-12">
                            <div class="card-columns">
                                <div class="card card-info bg-light border-info text-center">
                                    <div class="card-body">
                                        <asp:Image ID="ImageButton_book" CssClass="card-img-top" runat="server" Width="300" Height="400" />
                                    </div>
                                </div>
                                <div class="card border-info ">
                                    ...
                                    <div class="card-body">
                                        <asp:Label ID="lbl_author" CssClass="card-text text-info" runat="server" Text="Author: "></asp:Label>
                                        <asp:Label ID="lbl_author_black" CssClass="card-text " runat="server" Text="Label"></asp:Label>
                                        <br />
                                        <asp:Label ID="lbl_genre" CssClass="card-text text-info" runat="server" Text="Genre: "></asp:Label>
                                        <asp:Label ID="lbl_genre_black" CssClass="card-text" runat="server" Text="Label"></asp:Label>
                                        <br />
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <asp:Label ID="lbl_add_info" CssClass="card-text text-warning " runat="server" Text="The book added to shopping cart."></asp:Label><br /><br />
                                        ...
                                        <asp:Button ID="btn_go_to_default" CssClass="btn btn-outline-info btn-lg btn-block" runat="server" Text="Return To Main Page" OnClick="btn_go_to_default_Click" /><br />
                                    </div>
                                </div>
                            </div>
                        </div>
