                ...
                <div class="container">
                    <div class="row d-flex justify-content-center">
                        <aside class="col-sm-4">
                            <div class="card card-info border-info">
                                <article class="card-body">
                                    <h4 class="card-title text-center mb-10 mt-1">You have already logged in.</h4>
                                    <form>
                                        <div class="form-group">
                                            <asp:Button ID="btn_go_to_default" runat="server" Text="Go To Main Page" type="submit" CssClass="btn btn-light btn-block btn-lg" BorderColor="#E3F2FD" ClientIDMode="Predictable" ForeColor="Black" OnClick="btn_continue_Click" />
                                        </div>
                                        <div class="form-group">
