<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CentralAnatolia.aspx.cs" Inherits="WeatherForecast.CentralAnatolia" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CentralAnatolia</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container mt-5">
            <h2 class="text-center">İç Anadolu Bölgesi Hava Durumu</h2>
