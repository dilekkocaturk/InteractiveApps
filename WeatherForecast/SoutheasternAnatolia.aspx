<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoutheasternAnatolia.aspx.cs" Inherits="WeatherForecast.SoutheasternAnatolia" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SoutheasternAnatolia</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container mt-5">
            <h2 class="text-center">Güneydoğu Anadolu Bölgesi Hava Durumu</h2>
