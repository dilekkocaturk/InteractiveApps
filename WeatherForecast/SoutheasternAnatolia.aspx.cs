...
{
    public partial class SoutheasternAnatolia : System.Web.UI.Page
    {
        ...
        private void BindGridView()
        {
            ...
            string query = "SELECT City, FORMAT(WeatherDate, 'Short Date') AS WeatherDate, Description, Temperature, Humidity FROM Weather WHERE City IN ('Şırnak', 'Siirt', 'Batman', 'Mardin', 'Diyarbakır', 'Şanlıurfa', 'Adıyaman', 'Gaziantep', 'Kilis')";
