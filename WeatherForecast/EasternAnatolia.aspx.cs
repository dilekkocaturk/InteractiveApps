...
{
    public partial class EasternAnatolia : System.Web.UI.Page
    {
        ...
        private void BindGridView()
        {
            ...
            string query = "SELECT City, FORMAT(WeatherDate, 'Short Date') AS WeatherDate, Description, Temperature, Humidity FROM Weather WHERE City IN ('Iğdır', 'Ardahan', 'Kars', 'Muş', 'Bingöl', 'Elazığ', 'Malatya', 'Erzincan', 'Tunceli', 'Erzurum', 'Bitlis', 'Ağrı', 'Van', 'Hakkari')";
