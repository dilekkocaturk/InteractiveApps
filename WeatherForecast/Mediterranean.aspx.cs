...
{
    public partial class Mediterranean : System.Web.UI.Page
    {
        ...
        private void BindGridView()
        {
            ...
            string query = "SELECT City, FORMAT(WeatherDate, 'Short Date') AS WeatherDate, Description, Temperature, Humidity FROM Weather WHERE City IN ('Osmaniye', 'Adana', 'Isparta', 'Antalya', 'Burdur', 'Mersin', 'Hatay', 'Kahramanmaraş')";
