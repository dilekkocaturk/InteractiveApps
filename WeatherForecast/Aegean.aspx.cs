...
{
    public partial class Aegean : System.Web.UI.Page
    {
        ...
        private void BindGridView()
        {
            ...
            string query = "SELECT City, FORMAT(WeatherDate, 'Short Date') AS WeatherDate, Description, Temperature, Humidity FROM Weather WHERE City IN ('İzmir', 'Aydın', 'Muğla', 'Manisa', 'Uşak', 'Denizli', 'Afyonkarahisar', 'Kütahya')";
