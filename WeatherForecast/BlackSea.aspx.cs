...
{
    public partial class BlackSea : System.Web.UI.Page
    {
        ...
        private void BindGridView()
        {
            ...
            string query = "SELECT City, FORMAT(WeatherDate, 'Short Date') AS WeatherDate, Description, Temperature, Humidity FROM Weather WHERE City IN ('Artvin', 'Rize', 'Bayburt', 'Trabzon', 'Gümüşhane', 'Giresun', 'Ordu', 'Tokat', 'Amasya', 'Samsun', 'Sinop', 'Çorum', 'Kastamonu', 'Bartın', 'Karabük', 'Zonguldak', 'Düzce', 'Bolu')";
