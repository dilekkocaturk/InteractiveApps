<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EasternAnatolia.aspx.cs" Inherits="WeatherForecast.EasternAnatolia" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>EasternAnatolia</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container mt-5">
            <h2 class="text-center">Doğu Anadolu Bölgesi Hava Durumu</h2>
