<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="FlightReservation.Registration" %>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <asp:Label ID="lbl_altin_bilet" CssClass="card-text" runat="server" Text="Altın Bilet, bileti olduğu halde uçağı çeşitli sebeplerden dolayı kaçıran yolcularımıza yeniden yolculuk hakkı tanıyan bilet sistemidir."></asp:Label>
                                        <br />
                                        <br />
                                        <asp:CheckBox ID="CheckBox_altın_bilet" class="form-check-input checkbox-padding checkbox-label" Text=" Yanmaz bilet istiyorum." runat="server" />
                                        <br />
                                    </div>
                                </div>
                            </div>
