<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainPage.aspx.cs" Inherits="FlightReservation.MainPage" %>
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-danger">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <a class="navbar-brand" href="#">
                        <img src="https://icons.iconarchive.com/icons/iconka/business-outline/256/plane-icon.png" width="40" height="40" alt="" />
                    </a>
                    <a class="navbar-brand text-white font-weight-bold " href="">HAVAYOLU REZERVASYON SİSTEMİ</a>
                </div>
            ...
            <div class="container card  border-danger border-top-0 border-left-0 border-right-0" style="border-width: 2px;">
                <nav class="navbar navbar-expand-lg navbar-light ">
                    <a class="p-2 text-muted" href="#">PLANLA & UÇ</a>
                    <a class="p-2 text-muted" href="#">SEYAHAT DENEYİMİ</a>
                    <a class="p-2 text-muted" href="#">KEŞFET</a>
                    <a class="p-2 text-muted" href="#">YARDIM</a>
                </nav>
            </div>
        </header>
        <br />
                                        ...
                                        <tbody>
                                            <tr style="border-bottom: 0px !important;">
                                                <td class="text-center" style="width: 200px;">
                                                    <figure class="media">
                                                        <div class="img-wrap">
                                                            <asp:Label ID="lbl_sefer_time_1" CssClass="title text-truncate" runat="server" Text="03:30" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                                                        </div>
                                                    </figure>
                                                </td>
                                                <td class="">
                                                    <img src="http://icons.iconarchive.com/icons/icons8/ios7/128/Time-And-Date-Clock-icon.png" class="img-sm" width="15" height="15">
                                                    <asp:Label ID="lbl_sefer_from_1" runat="server" Text="Label" ForeColor="Gray">BURSA(03:30)</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <img src="http://icons.iconarchive.com/icons/icons8/ios7/128/Time-And-Date-Clock-icon.png" class="img-sm" width="15" height="15">
                                                    <asp:Label ID="lbl_sefer_to_1" runat="server" Text="Label" ForeColor="Gray">İSTANBUL(06:15)</asp:Label>
                                                    <br />
                                                    <br />
                                                    <div class="">
                                                ...
                                                <td class="text-right">
                                                    <asp:Label ID="lbl_sefer_price_1" CssClass="price" runat="server" Text="1500 ₺" Font-Size="Larger" ForeColor="#666666"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Button ID="btn_sefer_1" CssClass="btn btn-danger" runat="server" Text="Koltuk Seç" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="card" style="padding: 5px;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <asp:Panel ID="pnl_ucak_1" runat="server">
                                                    </asp:Panel>
                                                </div>
                                        ...
                                        <tbody>
                                            <tr style="border-bottom: 0px !important;">
                                                ...
                                                <td class="">
                                                    ...
                                                    <img src="http://icons.iconarchive.com/icons/icons8/ios7/128/Time-And-Date-Clock-icon.png" class="img-sm" width="15" height="15">
                                                    <asp:Label ID="lbl_sefer_to_2" runat="server" Text="Label" ForeColor="Gray">İSTANBUL(10:30)</asp:Label>
                                                    <br />
                                                    <br />
                                                    <div class="">
                                                        <img src="http://icons.iconarchive.com/icons/iconsmind/outline/128/Wifi-icon.png" class="img-sm" width="20" height="20">&nbsp;&nbsp;&nbsp;
                                                ...
                                                <td class="text-right">
                                                    <asp:Label ID="lbl_sefer_price_2" CssClass="price" runat="server" Text="1500 ₺" Font-Size="Larger" ForeColor="#666666"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Button ID="btn_sefer_2" CssClass="btn btn-danger" runat="server" Text="Koltuk Seç" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="card" style="padding: 5px;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <asp:Panel ID="pnl_ucak_2" runat="server">
                                                    </asp:Panel>
                                                </div>
                                        ...
                                        <tbody>
                                            <tr style="border-bottom: 0px !important;">
                                                ...
                                                <td class="">
                                                    ...
                                                    <img src="http://icons.iconarchive.com/icons/icons8/ios7/128/Time-And-Date-Clock-icon.png" class="img-sm" width="15" height="15">
                                                    <asp:Label ID="lbl_sefer_to_3" runat="server" Text="Label" ForeColor="Gray">İSTANBUL(12:15)</asp:Label>
                                                    <br />
                                                    <br />
                                                    <div class="">
                                                        <img src="http://icons.iconarchive.com/icons/iconsmind/outline/128/Wifi-icon.png" class="img-sm" width="20" height="20">&nbsp;&nbsp;&nbsp;
                                                ...
                                                <td class="text-right">
                                                    <asp:Label ID="lbl_sefer_price_3" CssClass="price" runat="server" Text="1500 ₺" Font-Size="Larger" ForeColor="#666666"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Button ID="btn_sefer_3" CssClass="btn btn-danger" runat="server" Text="Koltuk Seç" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="card" style="padding: 5px;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <asp:Panel ID="pnl_ucak_3" runat="server">
                                                    </asp:Panel>
                                                </div>
